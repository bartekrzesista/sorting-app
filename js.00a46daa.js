...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"normalize.css":"../node_modules/normalize.css/normalize.css","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/index.js":[function(require,module,exports) {
"use strict";

require("../scss/index.scss");

var input = document.querySelector(".sort__input");
var output = document.querySelector(".sort__output");
var btn = document.querySelector(".sort__btn");
...
var regexp = /^((\s*(0|([1-9][0-9]*)))\s*,\s*)+(0|([1-9][0-9]*))\s*$/;
btn.addEventListener("click", function () {
  if (regexp.test(input.value)) {
    if (errMsg.style.opacity == 1) errMsg.style.opacity = 0;
    var inputData = input.value.split(",").sort(compare);
